...
func (*KeyReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{0}
}
...
func (*AddrRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{1}
}
...
func (*AddrResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{2}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{3}
}
...
func (*PublishResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{4}
}
...
type SendOutputsRequest struct {
	// *
	// The number of atoms per kilo weight that should be used when crafting
	// this transaction.
	AtomsPerKw int64 `protobuf:"varint,1,opt,name=atoms_per_kw,json=atomsPerKw,proto3" json:"atoms_per_kw,omitempty"`
	// *
...
func (*SendOutputsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{5}
}
...
func (m *SendOutputsRequest) GetAtomsPerKw() int64 {
	if m != nil {
		return m.AtomsPerKw
	}
	return 0
...
func (*SendOutputsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{6}
}
...
func (*EstimateFeeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{7}
}
...
type EstimateFeeResponse struct {
	// *
	// The amount of atoms per kw that should be used in order to reach the
...
func (*EstimateFeeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_walletkit_c86085d85b322d56, []int{8}
}
...
func (m *EstimateFeeResponse) GetAtomsPerKw() int64 {
	if m != nil {
		return m.AtomsPerKw
	}
	return 0
...
type WalletKitClient interface {
	...
	// determine the fee (in atom/kw) to attach to a transaction in order to
...
func init() {
	proto.RegisterFile("walletrpc/walletkit.proto", fileDescriptor_walletkit_c86085d85b322d56)
}

var fileDescriptor_walletkit_c86085d85b322d56 = []byte{
	...
	0xd5, 0x22, 0x76, 0x22, 0x24, 0x67, 0xbe, 0xd4, 0xca, 0x9a, 0x0d, 0x1a, 0x1b, 0x21, 0x0d, 0x97,
	...
	0xf0, 0x9f, 0x25, 0xb5, 0xfb, 0x03, 0x00, 0x00,
}
