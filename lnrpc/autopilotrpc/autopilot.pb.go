...
func (*StatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_autopilot_00018c968003db1f, []int{0}
}
...
func (*StatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_autopilot_00018c968003db1f, []int{1}
}
...
func (*ModifyStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_autopilot_00018c968003db1f, []int{2}
}
...
func (*ModifyStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_autopilot_00018c968003db1f, []int{3}
}
...
func init() {
	proto.RegisterFile("autopilotrpc/autopilot.proto", fileDescriptor_autopilot_00018c968003db1f)
}

var fileDescriptor_autopilot_00018c968003db1f = []byte{
