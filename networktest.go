...
func (n *networkHarness) OnTxAccepted(hash *chainhash.Hash, amt dcrutil.Amount) {
	go func() {
		n.seenTxns <- *hash
	}()
}
...
func (n *networkHarness) OpenChannel(ctx context.Context,
	srcNode, destNode *lightningNode, amt dcrutil.Amount,
	pushAmt dcrutil.Amount) (lnrpc.Lightning_OpenChannelClient, error) {
