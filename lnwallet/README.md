...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/decred/dcrlnd/lnwallet)
...
The package is used within `dcrlnd` as the core wallet of the daemon. The wallet
...
`dcrlnd` without disrupting the code base. A series of integration tests at the
...
```bash
$ go get -u github.com/decred/dcrlnd/lnwallet
```
